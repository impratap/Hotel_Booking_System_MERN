...
function RoomDetails() {
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        {/* Room Address */}
        <div className='flex items-center gap-1 text-gray-500 m-2'>
        ...
        mx-auto mt-16 max-w-6xl'>
            ...
            md:items-center gap-4 md:gap-10 text-gray-500'>
                ...
                <div className='flex flex-col'>
                    ...
                    min={new Date().toISOString().split('T')[0]} type="date" id='checkInDate' placeholder='Check-In' className='w-full
                ...
                <div className='flex flex-col'>
                    ...
                    type="date" id='checkOutDate' placeholder='Check-Out' className='w-full
                    rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required/>
                </div>
                ...
                <div className='flex flex-col'>
                    ...
                    <input onChange={(e)=> setGuests(e.target.value)} value={guests} type="number" id='guests' placeholder='1' className='max-w-20 
                    rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required/>
                </div>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            ...
            You get a comfortable Two bedroom apartment has a tree city felling. The 
            price qouted is for two guest, at the guest slot please mark the number of guests 
            to get the exact price for groups. The Guest will be allocated on the ground floor  according to availability.
            You get a comfortable Two bedroom apartment has a tree city felling.
            </p>
        </div>
