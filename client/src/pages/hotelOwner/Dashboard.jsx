...
function Dashboard() {
  ...
  return (
    <div>
        ...
        {/*  Recent Bookings */}
        <h2 className='text-xl text-blue-950/70 font-medium md-5'>Recent Bookings</h2>
                    ...
                    {dashboardData.bookings.map((item,index)=>(
                        <tr key={index}>
                            ...
                            <td className='py-3 px-4 border-t border-gray-300 flex'>
                                <button className={`py-1 px-3 text-xs rounded-full mx-auto ${item.isPaid ? 'bg-green-200 text-gren-600' : 'bg-amber-200 text-yellow-600'}`}>
