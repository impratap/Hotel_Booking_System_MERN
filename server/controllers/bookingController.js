...
//     try {
//         const {room, checkInDate, checkOutDate} = ({})
...
//         res.json({success:true, message:"Booking Created sccessfully"})
...
export const createBooking = async (req, res) => {
  try {
    ...
    const user = req.user?._id;  // make sure auth middleware sets this
